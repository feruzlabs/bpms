...
/** id = eski `@Component("CalcPensionSumV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class CalcPensionSumV9Connector implements Connector {

    private final CalcPensionSumV9Service service;

    public CalcPensionSumV9Connector(CalcPensionSumV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "CalcPensionSumV9Connector";
    }
