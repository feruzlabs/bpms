...
/** id = eski {@code @Component("CheckKATMBanV9Connector")} */
public final class CheckKATMBanV9Connector implements Connector {

    private final CheckKATMBanV9Service service;

    public CheckKATMBanV9Connector(CheckKATMBanV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "CheckKATMBanV9Connector";
    }
