...
/** id = eski {@code @Component("CloseKATMV6Connector")} */
public final class CloseKATMV6Connector implements Connector {

    private final CloseKATMV6Service service;

    public CloseKATMV6Connector(CloseKATMV6Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "CloseKATMV6Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v6 close KATM request",
                List.of(
