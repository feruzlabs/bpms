...
/** id = eski `@Component("CloseKATMV8Connector")` */
public final class CloseKATMV8Connector implements Connector {

    private final CloseKATMV8Service service;

    public CloseKATMV8Connector(CloseKATMV8Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "CloseKATMV8Connector";
    }
