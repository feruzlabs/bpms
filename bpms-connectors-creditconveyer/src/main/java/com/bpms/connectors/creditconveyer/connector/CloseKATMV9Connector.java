...
/** id = eski `@Component("CloseKATMV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class CloseKATMV9Connector implements Connector {

    private final CloseKATMV9Service service;

    public CloseKATMV9Connector(CloseKATMV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "CloseKATMV9Connector";
    }
