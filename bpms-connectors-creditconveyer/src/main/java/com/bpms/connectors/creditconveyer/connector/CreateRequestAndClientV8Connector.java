...
/** id = eski {@code @Component("CreateRequestAndClientV8Connector")} */
public final class CreateRequestAndClientV8Connector implements Connector {

    private final CreateScoringRequestV8Service requestService;

    public CreateRequestAndClientV8Connector(CreateScoringRequestV8Service requestService) {
        this.requestService = requestService;
    }

    @Override
    public String id() {
        return "CreateRequestAndClientV8Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v8 create scoring request and client",
                List.of(
