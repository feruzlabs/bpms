...
/** id = eski {@code @Component("GetClientInfoV9Connector")} */
public final class GetClientInfoV9Connector implements Connector {

    private final GetClientInfoV9Service service;

    public GetClientInfoV9Connector(GetClientInfoV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "GetClientInfoV9Connector";
    }
