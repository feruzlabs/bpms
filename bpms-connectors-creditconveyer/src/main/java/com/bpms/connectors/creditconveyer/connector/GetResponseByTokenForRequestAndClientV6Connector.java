...
/** id = eski {@code @Component("GetResponseByTokenForRequestAndClientV6Connector")} */
public final class GetResponseByTokenForRequestAndClientV6Connector implements Connector {

    private final GetScoreResultV6Service service;
    private final Gson gson;

    public GetResponseByTokenForRequestAndClientV6Connector(GetScoreResultV6Service service, Gson gson) {
    ...
    @Override
    public String id() {
        return "GetResponseByTokenForRequestAndClientV6Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v6 scoring result by token",
                List.of(
