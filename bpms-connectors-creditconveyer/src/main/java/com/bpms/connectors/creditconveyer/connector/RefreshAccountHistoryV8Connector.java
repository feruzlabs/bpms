...
/** id = eski {@code @Component("RefreshAccountHistoryV8Connector")} */
public final class RefreshAccountHistoryV8Connector implements Connector {

    private final RefreshAccountHistoryV8Service service;
    private final Gson gson;

    public RefreshAccountHistoryV8Connector(RefreshAccountHistoryV8Service service, Gson gson) {
    ...
    @Override
    public String id() {
        return "RefreshAccountHistoryV8Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v8 refresh account history",
                List.of(
