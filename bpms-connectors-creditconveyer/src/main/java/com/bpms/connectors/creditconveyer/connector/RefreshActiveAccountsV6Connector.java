...
/** id = eski {@code @Component("RefreshActiveAccountsV6Connector")} */
public final class RefreshActiveAccountsV6Connector implements Connector {

    private final RefreshActiveAccountV6Service service;

    public RefreshActiveAccountsV6Connector(RefreshActiveAccountV6Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshActiveAccountsV6Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v6 refresh active accounts",
                List.of(
