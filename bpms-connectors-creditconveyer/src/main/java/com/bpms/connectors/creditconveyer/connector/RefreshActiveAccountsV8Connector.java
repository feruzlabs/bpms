...
/** id = eski `@Component("RefreshActiveAccountsV8Connector")` */
public final class RefreshActiveAccountsV8Connector implements Connector {

    private final RefreshActiveAccountV8Service service;

    public RefreshActiveAccountsV8Connector(RefreshActiveAccountV8Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshActiveAccountsV8Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(
                id(),
                "RefreshActiveAccountsV8Connector",
                List.of(
