...
/** id = eski `@Component("RefreshActiveAccountsV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class RefreshActiveAccountsV9Connector implements Connector {

    private final RefreshActiveAccountsV9Service service;

    public RefreshActiveAccountsV9Connector(RefreshActiveAccountsV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshActiveAccountsV9Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(
                id(),
                "RefreshActiveAccountsV9Connector",
                List.of(
