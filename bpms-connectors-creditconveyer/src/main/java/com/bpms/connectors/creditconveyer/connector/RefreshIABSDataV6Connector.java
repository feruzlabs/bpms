...
/** id = eski {@code @Component("RefreshIABSDataV6Connector")} */
public final class RefreshIABSDataV6Connector implements Connector {

    private final RefreshIABSV6Service service;

    public RefreshIABSDataV6Connector(RefreshIABSV6Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshIABSDataV6Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v6 refresh IABS data",
                List.of(
