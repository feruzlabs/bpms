...
/** id = eski `@Component("RefreshIABSDataV8Connector")` */
public final class RefreshIABSDataV8Connector implements Connector {

    private final RefreshIABSV8Service service;

    public RefreshIABSDataV8Connector(RefreshIABSV8Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshIABSDataV8Connector";
    }
