...
/** id = eski `@Component("RefreshIABSDataV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class RefreshIABSDataV9Connector implements Connector {

    private final RefreshIABSDataV9Service service;

    public RefreshIABSDataV9Connector(RefreshIABSDataV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshIABSDataV9Connector";
    }
