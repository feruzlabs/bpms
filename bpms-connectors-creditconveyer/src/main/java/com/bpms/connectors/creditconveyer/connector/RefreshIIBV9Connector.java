...
/** id = eski `@Component("RefreshIIBV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class RefreshIIBV9Connector implements Connector {

    private final RefreshIIBV9Service service;

    public RefreshIIBV9Connector(RefreshIIBV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshIIBV9Connector";
    }
