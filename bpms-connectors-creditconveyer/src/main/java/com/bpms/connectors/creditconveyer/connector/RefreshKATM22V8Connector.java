...
/** id = eski {@code @Component("RefreshKATM22V8Connector")} */
public final class RefreshKATM22V8Connector implements Connector {

    private final RefreshKATM22V8Service service;

    public RefreshKATM22V8Connector(RefreshKATM22V8Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshKATM22V8Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v8 refresh KATM 22",
                List.of(
