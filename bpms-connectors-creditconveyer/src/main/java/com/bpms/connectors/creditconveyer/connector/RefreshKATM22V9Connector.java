...
/** id = eski {@code @Component("RefreshKATM22V9Connector")} */
public final class RefreshKATM22V9Connector implements Connector {

    private final RefreshKATM22V9Service service;

    public RefreshKATM22V9Connector(RefreshKATM22V9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshKATM22V9Connector";
    }
