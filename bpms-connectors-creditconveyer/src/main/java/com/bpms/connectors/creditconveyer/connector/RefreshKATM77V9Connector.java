...
/** id = eski {@code @Component("RefreshKATM77V9Connector")} */
public final class RefreshKATM77V9Connector implements Connector {

    private final RefreshKATM77V9Service service;

    public RefreshKATM77V9Connector(RefreshKATM77V9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshKATM77V9Connector";
    }
