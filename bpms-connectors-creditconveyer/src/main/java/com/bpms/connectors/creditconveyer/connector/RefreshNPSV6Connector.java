...
/** id = eski {@code @Component("RefreshNPSV6Connector")} */
public final class RefreshNPSV6Connector implements Connector {

    private final RefreshNPSV6Service service;

    public RefreshNPSV6Connector(RefreshNPSV6Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshNPSV6Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v6 refresh NPS",
                List.of(
