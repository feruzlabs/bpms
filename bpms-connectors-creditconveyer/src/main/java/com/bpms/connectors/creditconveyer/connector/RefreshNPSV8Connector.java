...
/** id = eski `@Component("RefreshNPSV8Connector")` */
public final class RefreshNPSV8Connector implements Connector {

    private final RefreshNPSV8Service service;

    public RefreshNPSV8Connector(RefreshNPSV8Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshNPSV8Connector";
    }
