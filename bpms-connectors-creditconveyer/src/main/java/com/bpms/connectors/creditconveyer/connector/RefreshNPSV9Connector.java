...
/** id = eski `@Component("RefreshNPSV9Connector")` — BPMN camunda:connectorId bilan ayni. */
public final class RefreshNPSV9Connector implements Connector {

    private final RefreshNPSV9Service service;

    public RefreshNPSV9Connector(RefreshNPSV9Service service) {
        this.service = service;
    }

    @Override
    public String id() {
        return "RefreshNPSV9Connector";
    }
