...
/**
 * id = eski {@code @Component("TuneSentMobileAPIV7Connector")}.
 * Reuses {@link SendRequestV5XaznaService}; stop-factors stubbed as empty list.
 */
public final class TuneSentMobileAPIV7Connector implements Connector {

    private final SendRequestV5XaznaService xaznaService;
    private final Gson gson;

    public TuneSentMobileAPIV7Connector(SendRequestV5XaznaService xaznaService, Gson gson) {
    ...
    @Override
    public String id() {
        return "TuneSentMobileAPIV7Connector";
    }
    ...
    public ConnectorDescriptor describe() {
        return new ConnectorDescriptor(id(), "v7 Tune/Xazna mobile callback",
                List.of(
