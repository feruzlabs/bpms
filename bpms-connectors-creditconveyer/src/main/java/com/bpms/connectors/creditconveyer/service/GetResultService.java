...
@Service
public class GetResultService<R, E extends ErrorResponseDTO> {
    ...
    public GetResultService(Gson gson, GetTokenService getTokenService, OkHttpClient creditConveyerHttpClient) {
        this.gson = gson;
        this.getTokenService = getTokenService;
        this.httpClient = creditConveyerHttpClient;
    }

    public R result(String endpoint, String path, String token, Class<R> responseType, Class<E> errorClassType)
            throws IOException,
