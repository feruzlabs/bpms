...
import com.bpms.connectors.creditconveyer.dto.v9.MasterCardScoreResponseV9DTO;
...
@Service
public class MasterCardScoreV9Service {

    private final String endpoint;
    private final ConveyorClientV9 client;

    public MasterCardScoreV9Service(
    ...
    public MasterCardScoreResponseV9DTO refresh(String token)
            throws IOException, RefreshServiceErrorException, NotAuthorizedCreateNewRequestException {
        try {
            return client.get(
                    endpoint + ConveyorPathsV9.MASTERCARD_SCORE + token,
                    MasterCardScoreResponseV9DTO.class,
