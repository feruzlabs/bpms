...
public class CheckKATMBanV8Service {
    ...
    public Object refresh(String token) throws ServerErrorGetTokenAuthException,
        ...
        try {
            return refreshService.refresh(endpoint, ConveyorPaths.REFRESH_KATM_CHECK_BAN_V8, token, Object.class, ErrorResponseDTO.class);
