...
public class RefreshKATM77V8Service {
    ...
    public RefreshServiceResponseDTO refresh(String token) throws ServerErrorGetTokenAuthException,
        ...
        try {
            return refreshService.refresh(endpoint, ConveyorPaths.REFRESH_KATM_77_V8, token, RefreshServiceResponseDTO.class, ErrorResponseDTO.class);
